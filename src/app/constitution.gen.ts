...
export const PRINCIPLES: readonly ConstitutionItem[] = [
  { title: '사용자의 기억을 잃지 않는다.', body: '내구성 로컬 커밋(Dexie entity+operation atomic commit) 이후 앱 원인 유실은 0이다(브라우저 축출·사용자의 사이트데이터 삭제는 앱 통제 밖 → 백업·persist()·경고로 완화, docs/SYNC_PROTOCOL.md). 외부 원본 사진·영상은 사용자 기기에서 변경/삭제하지 않는다.' },
  { title: '사용자 기록과 AI 생성물을 섞지 않는다.', body: 'AI 출력은 사용자 필드가 아니라 ai_artifacts 테이블(Phase 7)에만 저장하고, AI 결과를 사용자 작성글처럼 표시하지 않는다.' },
  { title: '개인자료는 기본 비공개.', body: '여행·사진·영상·GPS·동행인·비용·회고 모두 비공개가 기본. 승인 없는 공유/소셜 기능 없음.' },
