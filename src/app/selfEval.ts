...
export const EVAL_ITEMS: EvalItem[] = [
  ...
  },
  {
    ...
    score: 90,
    evidence: 5,
    basis: `harness ${REGISTRY.gateCount}게이트(전부 셀프테스트 내장 — 알려진 실패를 주입해 RED 확인 후에만 신뢰), 유닛 + 라이브 렌더 77검사, 결함 재주입으로 비공허 실증을 반복 수행.`,
  ...
  },
  {
    ...
    score: 76,
    evidence: 3,
    basis: '라이브 렌더 77검사(경계 폭 12종 가로 넘침 0, 2단 전환, 상태 시각 위계), 토큰 기반 색·간격, 다크/계절 테마.',
