...
> **작성**: 2026-07-27 · **갱신 2026-07-30**(v1.27 「그 자리의 시계」 완결 · M-0051 · 장소 뚫는 길 v1.24~v1.26)
>
...
## 🟢 시작하기 전에 — 코덱스에게 (2026-07-30, 인계 세션이 남기는 말)
...
| 현재 판 | **v1.27** — 배포 그린 확인됨(Pages run #174, `f70a0fe`). 아래 §6 |
...
## 6. 지금 저장소 상태 (2026-07-30 세션 종료 시점)
...
전체는 `docs/records/coding-mistakes.md`(M-0001 ~ **M-0051**, 최신이 위). 근본형만 추린다.
