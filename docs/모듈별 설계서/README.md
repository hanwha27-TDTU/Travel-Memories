...
현재 모집단은 321개 파일, 18개 모듈, 78201개 논리 줄이다. 이 숫자는 생성기가 매번 다시 센다.
...
| 18 | 검증 게이트·생성기·릴리스 시스템 | [18-검증과-릴리스-시스템.md](./18-%EA%B2%80%EC%A6%9D%EA%B3%BC-%EB%A6%B4%EB%A6%AC%EC%8A%A4-%EC%8B%9C%EC%8A%A4%ED%85%9C.md) | 119 | 26495 | `ff8e55cb972fe98e…` |
