...
- **TASK-0100** · v1.69 — 홈 카드 축약·동기화 상태 상단 이동·감정 10종·기간 요일과 릴리스 묶음 정책/게이트. 구현 완료, 전체 릴리스 절차로 인계.
- **TASK-0000** · Gate 0A — v0.2 설계 리비전을 거버넌스/레지스트리 문서에 병합(문서 전용). 완료.
- **TASK-0006** · Phase 1 thin slice(trips 로컬층) — 서비스·UI·rowmap·migration/RLS 아티팩트. 하네스·브라우저 왕복 통과. 완료(서버 적용은 Q4 대기).
